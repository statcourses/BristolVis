...
%\VignetteIndexEntry{Practical 3 - Advanced graphics}
-->
...
### 4. Is there a difference on rating depending on genre? (Hint: you may use `geom_violin`)
```{r}
...
### 5. Is the rating influenced by the number of votes? (Hint: you may use `stat_binhex`)
```{r}
