---
title: "Practical 6 - Interactive documents"
author: "Osama Mahmoud"
output: rmarkdown::html_vignette
---
<!--
%\VignetteEngine{knitr::rmarkdown}
%\VignetteIndexEntry{Practical 6 - Interactive documents}
-->
...
```{r med-histogram, echo=FALSE, eval=FALSE}
data(med, package = 'BristolVis')
library(ggplot2)
inputPanel(
...
```{r med-scatter, echo=FALSE, eval=FALSE}
inputPanel(
...
- Add a new R chunk to your document to embed the 'hello' Shiny application located in the example directory of the shiny package (use: `system.file("examples/01_hello", package="shiny")` to locate the directory of the app):
